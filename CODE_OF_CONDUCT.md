...
in the ProjectHub community a harassment-free experience for everyone,
...
requests, discussions, and any other project-associated
...
reported to the project maintainers via a private [GitHub Security
Advisory](https://docs.github.com/en/code-security/security-advisories/guidance-on-reporting-and-writing/privately-reporting-a-security-vulnerability)-style
private channel if available, or by email to
`conduct@projecthub.example` (a placeholder address - replace with a real,
monitored inbox before a public 1.0 release). All complaints will be
...
1. **Correction** - A private, written warning, providing clarity around
   the nature of the violation and why the behavior was inappropriate.
