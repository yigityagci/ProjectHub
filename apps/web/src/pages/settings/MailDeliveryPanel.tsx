...
// Straight port of the deleted apps/web/src/pages/platform/PlatformEmailSettingsPage.tsx
// (formerly routed at /platform-settings/email) into this panel — no copy
// changes, no new features, only the page-level shell chrome (Brand/
// topbar/breadcrumb) dropped, mirroring how ManageTeamTab.tsx documents
// its own port of the deleted WorkspaceMembersPage.tsx. The page's old
// "Email Configuration" <h1> + Enabled/Disabled status pill move in here
// as this panel's own heading, since ProjectHubAdminTab/SettingsPage own
// their own page-level <h1> already.
